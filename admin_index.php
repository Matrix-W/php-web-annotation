<?php
    ...
    if (empty($id)) {
        ...
        $sql = " select * from tagging where paragraph_id = (select paragraph_id from (select paragraph_id,user_name from tagging group by paragraph_id ) as o  order by o.paragraph_id asc limit 0, 1)";
    }
    else {
        $sql = " select * from tagging where paragraph_id = (select paragraph_id from (select paragraph_id,user_name from tagging group by paragraph_id ) as o order by o.paragraph_id asc limit $id, 1)";
    }
    $res = custom_query($sql);
    $sql_count = "select count(*) as count from tagging";
...
<body>
        ...
        <div class="container_main">
            ...
            <div>
                <button type="button" <?php if (empty($id)) echo "disabled";  ?>
                    onclick="location.href = '<?php echo 'admin_index.php?id='.($id - 1)  ?>';"
    ...
    <!-- Footer -->
    <div id="f_menu">
        <!-- <button type="button" class="btn btn-success" id="tagging">标注</button>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <ul>
                            <?php
                                $sql = "select * from tagging_sentence_words";
